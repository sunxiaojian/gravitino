...
public class GravitinoIcebergCatalogFactory implements CatalogFactory {

  public static final String IDENTIFIER = "gravitino-iceberg";

  private FlinkCatalogFactory icebergCatalogFactory;

  @Override
  public Catalog createCatalog(Context context) {
    this.icebergCatalogFactory = new FlinkCatalogFactory();
  ...
  public Set<ConfigOption<?>> requiredOptions() {
    return ImmutableSet.<ConfigOption<?>>builder()
        .addAll(icebergCatalogFactory.requiredOptions())
        .build();
  }
  ...
  public Set<ConfigOption<?>> optionalOptions() {
    return ImmutableSet.<ConfigOption<?>>builder()
        .addAll(icebergCatalogFactory.optionalOptions())
        .build();
  }
}
